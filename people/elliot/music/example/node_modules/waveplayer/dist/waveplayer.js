...
var WaveView = function () {
    ...
    function WaveView(data, options) {
        ...
        if (!WavePlayer$1._mediator) {
            WavePlayer$1._mediator = new Mediator();
        }
    ...
    _createClass(WaveView, [{
        ...
        value: function _addCanvasHandlers() {
            ...
            this._mouseClickHandler = function (e) {
                return WavePlayer$1._mediator.fire('waveview:clicked', _this._coord2Progress(e));
            };
    ...
    _createClass(Playlist, [{
        ...
        value: function _createScheduler(urls, autoPlay) {
                ...
                return regenerator.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                if (this._currentTrackIndex > 0) {
                                    WavePlayer$1._mediator.fire('waveplayer:playlist:next', this._wavePlayer, { url: urls[this._currentTrackIndex], trackNumber: this._currentTrackIndex + 1 });
                                    this._wavePlayer.play();
                                } else {
                                    WavePlayer$1._mediator.fire('waveplayer:playlist:ready', this._wavePlayer);
            ...
            scheduler(urls).then(function (response) {
                ...
                WavePlayer$1._mediator.fire('waveplayer:playlist:finished', _this._wavePlayer, response);
            });
